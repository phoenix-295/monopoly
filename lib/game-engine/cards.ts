...
export const CHANCE_CARDS: Card[] = [
  { id: 'ch1',  text: 'Advance to Mumbai.',                                      action: { type: 'move_to', squareIndex: 39, collectGo: true } },
  { id: 'ch2',  text: 'Advance to Go (Collect ₹200).',                           action: { type: 'move_to', squareIndex: 0, collectGo: true } },
  { id: 'ch3',  text: 'Advance to Delhi. If you pass Go, collect ₹200.',         action: { type: 'move_to', squareIndex: 24, collectGo: true } },
  { id: 'ch4',  text: 'Advance to Jaipur. If you pass Go, collect ₹200.',        action: { type: 'move_to', squareIndex: 11, collectGo: true } },
  { id: 'ch5',  text: 'Advance token to the nearest Railway Station.',            action: { type: 'move_to_nearest', squareType: 'railroad' } },
  { id: 'ch6',  text: 'Advance token to the nearest Railway Station.',            action: { type: 'move_to_nearest', squareType: 'railroad' } },
  ...
  { id: 'ch14', text: 'Take a trip to Howrah Station. If you pass Go, collect ₹200.', action: { type: 'move_to', squareIndex: 5, collectGo: true } },
